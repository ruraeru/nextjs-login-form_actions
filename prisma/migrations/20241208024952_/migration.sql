/*
  ...
  - You are about to drop the column `responseId` on the `Tweet` table. All the data in the column will be lost.
  - Added the required column `tweetId` to the `Response` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Response" ("created_at", "id", "likeTweetId", "likeUserId", "payload", "updated_at") SELECT "created_at", "id", "likeTweetId", "likeUserId", "payload", "updated_at" FROM "Response";
DROP TABLE "Response";
