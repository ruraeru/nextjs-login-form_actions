...
INSERT INTO "new_Response" ("created_at", "id", "likeTweetId", "likeUserId", "payload", "tweetId", "updated_at") SELECT "created_at", "id", "likeTweetId", "likeUserId", "payload", "tweetId", "updated_at" FROM "Response";
DROP TABLE "Response";
