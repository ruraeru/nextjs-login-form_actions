...
export default function Input({ name, errors = [], width = "full", height = "10", ...rest }: InputProps & InputHTMLAttributes<HTMLInputElement>) {
    return (
        <div className="flex flex-col gap-2">
            <div className="flex items-center relative">
                ...
                <input
                    name={name}
                    className={`bg-transparent rounded-3xl px-10 py-6 w-${width} 
            h-${height} focus:outline-none ring-2 focus:ring-4 transition
            bg-none
